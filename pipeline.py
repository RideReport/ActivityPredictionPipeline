...
def dispatchCommand(command, options):
    if options.config_filename is None:
        ...
        config_json['builder'] = options.builder_kwargs
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--builder-kwargs', dest='builder_kwargs', default='{}', type=json.loads)
    parser.add_argument('--exclude-crowd-data', dest='exclude_crowd_data', action='store_false', default=True)
